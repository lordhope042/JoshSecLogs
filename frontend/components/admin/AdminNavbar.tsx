...
export default function AdminNavbar({
  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-zinc-800 bg-[#090d14]/95 px-8 backdrop-blur">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="hidden items-center rounded-xl border border-zinc-700 bg-[#121826] px-4 py-2 md:flex">
        ...
        <button className="relative rounded-xl border border-zinc-700 bg-[#121826] p-3 hover:border-orange-500">
