      ...
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="hidden rounded-xl p-2 text-zinc-400 transition hover:bg-zinc-800 md:block"
          >
          ...
          <div className="hidden lg:block">
            ...
            <p className="text-sm text-zinc-500">Manage your virtual services</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <div className="mt-1">
                {walletLoading ? (
                  ...
                  <p className="font-bold text-zinc-500">No Wallet</p>
                )}
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="relative rounded-2xl border border-zinc-800 bg-zinc-900 p-3 transition hover:border-orange-500 hover:bg-zinc-800"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-900 px-3 py-2 transition hover:border-orange-500"
          >
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-orange-500 to-orange-600 text-lg font-bold text-white">
            ...
            <ChevronDown size={18} className="hidden text-zinc-500 md:block" />
          </button>
        </div>
      </div>
    </header>
